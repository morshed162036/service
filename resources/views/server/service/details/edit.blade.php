            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('service.update',$detail->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <input name="name" id="name" value="{{ $detail->name }}" class="form-control" required>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                               ...
                                               <input type="text" class="form-control" value="{{ $detail->category->name }}" readonly>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Change Category <span class="star">*</span></h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-spreadsheet"></i></span>
                                                </div>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <input name="price" id="price" value="{{ $detail->price }}" class="form-control" required>
                                        </fieldset>
                                        <fieldset class="mt-2">
