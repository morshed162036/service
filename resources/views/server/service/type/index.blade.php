                                        ...
                                        <tbody>
                                            @if ($services)
                                                @foreach ($services as $service)
                                                    <tr>
                                                        <td class="text-bold-600" >{{ $service->title }}</td>
                                                        <td><img src="{{ asset('images/service/'.$service->image) }}" alt="" height="150px"></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('service.edit',$service->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('service.destroy',$service->id) }}" method="post"> @csrf @method('Delete')
